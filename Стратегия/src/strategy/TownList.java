...
public class TownList {
	...
	public static void list() {
		...
		Game.town.add(new Town(Town.CENTER, 2, 2).setNam("Мурманск"));
		Game.town.add(new Town(Town.CENTER, 5, 2).setNam("Москва"));
		Game.town.add(new Town(Town.UP_LEFT, 0, 0).setNam("Рим"));
		Game.town.add(new Town(Town.UP_LEFT, 0, 1).setNam("Тверь"));
		Game.town.add(new Town(Town.UP_LEFT, 1, 0).setNam("Владивосток"));
