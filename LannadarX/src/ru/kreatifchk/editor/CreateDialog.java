...
public class CreateDialog extends JLabel implements ChangeListener {
	...
	public CreateDialog() {
		...
		create.addActionListener((e) -> {
			...
			int x = Integer.parseInt(widtValue.getText()), y = Integer.parseInt(heigValue.getText()); //Кол-во полей по x и по н
	...
	public void stateChanged(ChangeEvent a) {
		if (a.getSource() == widt) {
			widtValue.setText(widt.getValue() + "");
		}
		if (a.getSource() == heig) {
			heigValue.setText(heig.getValue() + "");
		}
		repaint();
	}
